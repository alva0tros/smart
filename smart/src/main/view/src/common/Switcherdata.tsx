...
export function Dark(actionfunction: any) {
    ...
    if (
        localStorage.getItem("nowadarktheme") &&
        localStorage.getItem("nowaHeader") &&
...
export const HorizontalClick = (actionfunction: any) => {
    ...
    const updatedTheme = {
        ...
        datamenustyles: localStorage.nowadarktheme
            ? "dark"
            : localStorage.darkBgRGB1
            ? localStorage.nowaMenu
            : localStorage.nowaMenu
            ? localStorage.nowaMenu
            : "light",
        dataverticalstyle: "",
...
export const LocalStorageBackup = (actionfunction: any) => {
    ...
    //primitive
    if (localStorage.getItem("nowaltr") == null || localStorage.getItem("nowaltr") == "ltr")
