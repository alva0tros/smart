...
const Switcher: FC<SwitcherProps> = ({ local_varaiable, ThemeChanger, show, onClose }) => {
    ...
    const customStyles: any = generateCustomStyles();
            ...
            >
                ...
                <Offcanvas.Body>
                    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                        <Nav variant="" className="border-bottom border-block-end-dashed nav-justified">
                            <Nav.Item>
                                <Nav.Link eventKey="first">Theme Styles</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link eventKey="second">Theme Colors</Nav.Link>
                            </Nav.Item>
                        </Nav>
                        <Tab.Content id="nav-tabContent">
                            <Tab.Pane eventKey="first" id="switcher-home" className="border-0">
                                <div className="">
                                        ...
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input
                                                    ...
                                                    checked={local_varaiable.datathememode === "light"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="col-sm-6">
                                            <div className="form-check switch-select">
                                                ...
                                                <input
                                                    ...
                                                    checked={local_varaiable.dataverticalstyle === "overlay"}
                                                    onChange={(_e) => {}}
                                    ...
                                    <div className="row switcher-style gx-0">
                                        ...
                                        <div className="col-4">
                                            <div className="form-check switch-select">
                                                ...
                                                <input className="form-check-input" type="radio" name="page-loader" id="switcher-loader-disable" checked />
                                            </div>
                                        </div>
                                    </div>
                                </div> */}
                            </Tab.Pane>
                            <Tab.Pane eventKey="second" id="switcher-profile" className="border-0">
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Light Menu</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.datamenustyles == "light"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Dark Menu</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.datamenustyles == "dark"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Color Menu</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.datamenustyles == "color"}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Gradient Menu</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.datamenustyles == "gradient"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Transparent Menu</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.datamenustyles == "transparent"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Light Header</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.dataheaderstyles === "light"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Dark Header</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.dataheaderstyles === "dark"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Color Header</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.dataheaderstyles === "color"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Gradient Header</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.dataheaderstyles === "gradient"}
                                                    onChange={(_e) => {}}
                                        ...
                                        <div className="form-check switch-select me-3">
                                            <OverlayTrigger overlay={<Tooltip>Transparent Header</Tooltip>}>
                                                <input
                                                    ...
                                                    defaultChecked={local_varaiable.dataheaderstyles === "transparent"}
                                                    onChange={(_e) => {}}
