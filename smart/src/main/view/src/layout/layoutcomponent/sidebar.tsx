...
const Sidebar: FC<actiontype> = ({ local_varaiable, ThemeChanger }) => {
    ...
    function Onhover() {
        ...
        if (
            (theme.toggled == "icon-overlay-close" || theme.toggled == "detached-close") &&
    ...
    function setSubmenu(event: any, targetObject: Menuitemtype, MENUITEMS = menuitems) {
        const theme = store.getState();
        if (
            (window.screen.availWidth <= 992 || theme.datanavlayout != "icon-hover") &&
    ...
    function handleAttributeChange(mutationsList: any) {
        for (const mutation of mutationsList) {
            if (
                ...
                (mutation.attributeName === "data-nav-layout" || mutation.attributeName === "data-vertical-style")
            ) {
                                            ...
                                            >
                                                ...
                                                {localStorage.nowalayout === "horizontal" ? (
                                                    ...
                                                    <div className="custom-tooltip">
                                                        <OverlayTrigger
                                                            placement={localStorage.nowartl ? "left" : "right"}
