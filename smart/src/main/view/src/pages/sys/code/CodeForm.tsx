...
const CodeForm: React.FC<any> = ({ gridRef, params, setParams, refetch, mutate, setError }) => {
        ...
        >
            <div className="col-12">
                <InputGroup>
                    ...
                    <Form.Control {...register("menu_nm")} type="text" size="sm" placeholder="코드 입력" />
                </InputGroup>
            </div>
            <div className="col-12">
                <InputGroup>
                    <InputGroup.Text>코드명</InputGroup.Text>
                    <Form.Control {...register("menu_nm")} type="text" size="sm" placeholder="코드명 입력" />
                </InputGroup>
            </div>
